...
<input type="number" class="angkaC" name="txtJumlah" size="2" maxlength="4" value="1"
...
<?php
  ...
  <tr>
    <td colspan="4" align="right" bgcolor="#F5F5F5"><b>Total Harga (Rp.) : </b></td>
  ...
  <tr>
  	<td colspan="4" align="right" bgcolor="#F5F5F5"><b>PPN (%) : </b></td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#F5F5F5">&nbsp;</td>
    <td align="right" bgcolor="#F5F5F5"><b><?php echo format_angka($total); ?></b></td>
    <td align="center" bgcolor="#F5F5F5">&nbsp;</td>
  </tr>
  <tr>
